 ...
 */
public class CallListenerClient implements DeviceListener, ConnectionListener {

    private static final String AUTH_PHP_SCRIPT = "http://sudo.my/gcm/callback.php";
    ...
    private static CallListenerClient instance;
    public static final CallListenerClient getInstance(Context context)
    {
        if (instance == null)
            instance = new CallListenerClient(context);
        return instance;
    }
    ...
    private CallListenerClient(Context context)
    {
    ...
    public boolean handleIncomingIntent(Intent intent)
    {
        ...
        if (pendingIncomingConnection != null) {
            Log.i("Heyz", "A pending connection already exists");
            inConnection.ignore();
            return false;
        }
    ...
    private class GetAuthTokenAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            CallListenerClient.this.reallyLogin(result);
        }
