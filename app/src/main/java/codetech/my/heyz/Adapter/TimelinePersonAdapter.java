 ...
 */
public class TimelinePersonAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<TimelinePersonArray> mItems = new ArrayList<TimelinePersonArray>();

    public TimelinePersonAdapter(Context context, ArrayList<TimelinePersonArray> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try{
            ViewHolder holder;
            try{
                TimelinePersonArray item = (TimelinePersonArray) this.getItem(position);

                if(convertView == null) {
                    holder = new ViewHolder();
                    LayoutInflater li = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    convertView  = li.inflate(R.layout.timelineperson_row, parent, false);
