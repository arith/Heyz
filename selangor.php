...
<body onload="initPieChart();">
    ...
    <p>Land Area: <b>8,104 km² (3,129 sq mi) km²</b></p>
    <p>Population: <b>8,464,141</b></p>
    <p>District: <b>9</b></p>
</div>

 <div id="chart" style="background: center no-repeat url('img/world-map.png');"></div> 

<table id="selangortable" width='100%' border='1' class="table-responsive table-dt table-hover table-bordered-dt dataTable" >
...
// $sql=("SELECT * FROM location WHERE country='MY' AND region='01' GROUP BY city");
...
// $char = implode(' ',reverse_geocode('3.081213', '101.58441080000001'));
...
?>
    ...
    <script type="text/javascript" charset="utf8" src="selangor.tables.js"></script>
